...
### Block 5.5 — Automation triggers

- Are there tasks that should happen automatically when certain events occur? _(e.g., validation after file creation, notification after deployment, QA after entity approval)_
- Are there recurring automated procedures the system should run? _(e.g., linting, data processing, health checks, deployment scripts)_
- Should any actions fire automatically when the user starts a session, changes a file, or completes a task?
- For each automated action: what event triggers it, and what action should it perform?
