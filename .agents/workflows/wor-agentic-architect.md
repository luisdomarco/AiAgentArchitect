...
| **Agent**                       | **Route**                            | **When**                                                     |
| ------------------------------- | ------------------------------------ | ------------------------------------------------------------ |
| `age-spe-input-enricher`        | `./age-spe-input-enricher.md`        | Step 0: reestructuración y enriquecimiento del input inicial |
...
| `ski-context-ledger`    | `../skills/ski-context-ledger/SKILL.md`    | Inicio: inicializar ledger. Tras cada Step: write/read       |
