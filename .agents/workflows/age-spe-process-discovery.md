...
| --------------------------- | ------------------------------------------------ | -------------------------------------------------------------- |
| `kno-entity-types` | `../knowledge-base/kno-entity-types.md` | To understand what type of entity the user might be describing |
...
**Pre-step — Compliance self-check:** Before building the handoff JSON, emit a `<sys-eval>` block as required by `rul-strict-compliance`. List your active Hard Constraints and verify all assigned Tasks have been executed. Only proceed after closing the tag.
...
In Evolve Mode: `mode: "evolve"`, `existing_system_summary`, and user description of new capabilities.
