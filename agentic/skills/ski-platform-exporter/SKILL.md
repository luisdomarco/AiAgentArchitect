...
- Comprobar que existe `exports/{nombre}/google-antigravity/.agent/`
...
Escanear `.agent/` y registrar todas las entidades encontradas:
...
1. Leer el archivo fuente desde `.agent/{tipo}/{nombre}`
