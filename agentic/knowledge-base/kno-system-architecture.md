...
Todos los sistemas generados se exportan primero a Google Antigravity. La estructura coloca todas las entidades dentro de `.agent/` para máxima compatibilidad.
...
**Nota sobre paths**: Los workflows y agents usan rutas relativas como `./agents/age-xxx.md` o `./skills/ski-xxx/SKILL.md`. Estas rutas se resuelven desde `.agent/` como raíz, dado que todas las carpetas son siblings directos dentro de `.agent/`.
...
|---|---|---|---|
| Workflow | `.agent/workflows/wor-xxx.md` | `.claude/commands/wor-xxx.md` | `workflows/wor-xxx.md` |
| Agent | `.agent/agents/age-xxx.md` | `.claude/agents/age-xxx.md` | `agents/age-xxx.md` |
| Skill | `.agent/skills/ski-xxx/SKILL.md` | `.claude/skills/ski-xxx/SKILL.md` | `skills/ski-xxx.zip` |
| Rule | `.agent/rules/rul-xxx.md` | Integrada en `CLAUDE.md` | `rules/rul-xxx.md` |
| Knowledge-base | `.agent/knowledge-base/kno-xxx.md` | `knowledge-base/kno-xxx.md` + ref en `CLAUDE.md` | `knowledge-base/kno-xxx.md` |
| Command | `.agent/commands/com-xxx.md` | `.claude/commands/com-xxx.md` | `commands/com-xxx.md` |
| process-overview | `.agent/process-overview.md` | `process-overview.md` | `process-overview.md` |
