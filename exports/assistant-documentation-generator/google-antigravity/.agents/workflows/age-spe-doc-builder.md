...
- **G4:** Escribir los archivos generados en sus correspondientes carpetas dentro de `docs/{title}/output/`.
- **G5:** Terminar generando un `{title}-overview.md` con el índice y resumen de todo lo creado.
...
3. **Escritura en Disco:** Redacta los archivos en `docs/{title}/output/[subcarpeta]/`.
4. **Resumen:** Genera el archivo principal `docs/{title}/output/{title}-overview.md` con:
   - Título y objetivo.
