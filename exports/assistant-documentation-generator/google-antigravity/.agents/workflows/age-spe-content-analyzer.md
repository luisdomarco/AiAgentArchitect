...
- Leer el archivo `input.md` para extraer el Título, el Objetivo y las URLs de contexto.
...
1. **Lectura de Configuración:** Abre y lee el `docs/{title}/input/input.md` para anclar el objetivo de generación.
...
- **Path Context:** Ruta base del proyecto `docs/{title}/input/`
- **Config:** Archivo `input.md` con Objetivo y descripciones.
- **Raw Data:** Archivos fuente (PDFs, Markdown, texto libre, etc.) ubicados en esa misma carpeta.
