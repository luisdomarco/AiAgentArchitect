...
| ------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------- |
| `ski-entity-file-builder` | `../skills/ski-entity-file-builder.md` | Para generar el contenido de cada entidad según su tipo y nivel                 |
| `ski-diagram-generator`   | `../skills/ski-diagram-generator.md`   | Para generar los diagramas del `process-overview.md`                            |
| `ski-qa-embed`            | `../skills/ski-qa-embed.md`            | Opcional: embeber el QA Layer en el sistema generado, si el usuario lo solicita |
