...
| **Agent**                       | **Route**                            | **When**                                                      |
| ------------------------------- | ------------------------------------ | ------------------------------------------------------------- |
| `age-spe-input-enricher`        | `../agents/age-spe-input-enricher.md`        | Step 0: restructuring and enrichment of the initial input     |
| `age-spe-process-discovery`     | `../agents/age-spe-process-discovery.md`     | Step 1: interview and discovery                               |
| `age-spe-architecture-designer` | `../agents/age-spe-architecture-designer.md` | Step 2: Blueprint design                                      |
| `age-spe-entity-builder`        | `../agents/age-spe-entity-builder.md`        | Step 3: file generation                                       |
| `age-spe-auditor`               | `../agents/age-spe-auditor.md`               | QA Layer: audits compliance after each checkpoint             |
| `age-spe-evaluator`             | `../agents/age-spe-evaluator.md`             | QA Layer: scores quality and updates qa-report.md             |
| `age-spe-optimizer`             | `../agents/age-spe-optimizer.md`             | QA Layer: detects patterns and proposes improvements at close |
